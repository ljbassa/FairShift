...
def parse_args():
    ...
    parser.add_argument(
        ...
        nargs="*",
        default=[],
        help="Existing controller-grid summary CSVs to include in the final Pareto plot.",
    )
...
def run_generated_pareto(args, repo_dir, controller_root):
    ...
    for extra_summary_csv in args.pareto_extra_summary_csv:
        ...
        plot_cmd += ["--extra_summary_csv", str(extra_summary_csv)]
    ...
    return summary_csv, plot_path, front_csv, plot_proc.returncode
...
def main():
    ...
    if args.run_generated_eval and not args.skip_generated_pareto and not args.dry_run:
        ...
        if pareto_returncode == 0:
            ...
            print(f"[grid] generated LP Pareto front: {front_csv}")
        else:
