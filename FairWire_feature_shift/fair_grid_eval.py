...
def parse_args():
    p = argparse.ArgumentParser(
        description="FairWire_feature_shift eta/k logit-shift grid with generated-graph LP evaluation."
    )
    ...
    p.add_argument("--largest_cc", type=str2bool, default=False, help="Accepted for CLI compatibility. FairWire_feature_shift currently evaluates the full saved PyG graphs.")
    p.add_argument("--graph_variant", type=str, default="full", choices=["full", "eval"], help="Accepted for CLI compatibility. FairWire_feature_shift saves one full PyG graph list.")
