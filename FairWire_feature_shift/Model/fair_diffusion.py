...
class ModelSync(BaseModel):
    ...
    def sample(self,
        ...
        sp_shift : bool
            ...
            sampling. This does not update parameters or alter fixed features.
        sp_eta : float
            Strength of the post-hoc SP edge-logit shift. 0.0 keeps the
            original sampler path.
        sp_k : float
            Multiplicative scale for the SP edge-logit shift gradient.
        sp_eta_schedule : str
