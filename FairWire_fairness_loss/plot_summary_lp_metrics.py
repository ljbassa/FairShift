...
DEFAULT_X_METRIC = "lp/score_sp_abs_gap_mean"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Metric for the x-axis. Default: lp/score_sp_abs_gap_mean",
    )
    parser.add_argument(
        "--y_metric",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Output image path. Default: generated_graphs/lp_auc_vs_score_sp_abs_gap.png",
    )
    parser.add_argument(
        "--title",
        type=str,
        default="LP AUC vs score SP absolute gap",
        help="Plot title.",
    )
    parser.add_argument(
        "--no_error_bars",
...
def resolve_metric(fieldnames: Sequence[str], requested: str) -> str:
    ...
    if requested in {
        ...
        candidates.append("lp/score_sp_abs_gap_mean")
...
def default_out_path(graphs_dir: Path, csv_paths: Sequence[Path]) -> Path:
    if len(csv_paths) == 1:
        ...
        return graphs_dir / f"{label}.lp_auc_vs_score_sp_abs_gap.png"
    return graphs_dir / "lp_auc_vs_score_sp_abs_gap.png"
