...
def build_parser():
    ...
    parser.add_argument('--fair_score_sp', action='store_true', help='deprecated compatibility flag; no longer changes sampling')
...
def run_evaluate(eval_args):
    ...
    args.diffusion_stage = getattr(args, 'diffusion_stage', 'stage1_base')
